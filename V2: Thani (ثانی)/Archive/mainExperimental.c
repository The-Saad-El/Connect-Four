...
/*
    ...
    [!]  play: custom match, quick match           view: achievements, leaderboards, gameHistory, resumeGame, help
...
#define animateTextDelay_13ms 13        // the arbitrary timeDelay_ms of 33ms used as the argument of the animateText() chiefly for displayHistory()
...
{   
    ...
    FILE *fPtr = fopen("gameFiles/leaderBoards.txt", "a");
    if (fPtr == NULL)
    { 
